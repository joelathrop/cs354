...
public class Scanner {
	...
	// initWhitespace method adds whitespace characters
	// such as the space (" "), the newline, (\n),
	// and the tab (\t) to the set s.
	// Arguments: 
	// 	s = a Set of strings
	...
	// initDigits method fills set s with
	// digits 0-9 to the set s.
	// Arguments:
	// 	s = a Set of strings
	...
	// initLetters method fills the set s with Letters A-Z,
	...
	// initComments adds a custom comment operator
	// to the set.
	// Arguments:
	// 	s = a Set of strings
	...
	// initOperators fills the set s with defined operators,
	// including: equals, addition, subtraction,
